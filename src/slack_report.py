...
NOISE_PATTERNS = [
    ...
    re.compile(r"^--- End of", re.IGNORECASE),
    re.compile(r"^System\.Runtime\.CompilerServices\.AsyncTaskMethodBuilder", re.IGNORECASE),
    re.compile(r"^Cysharp\.Threading\.Tasks\.UniTaskCompletionSourceCore", re.IGNORECASE),
...
ISSUE_RULES = [
    IssueRule(
        ...
        patterns=(
            ...
            re.compile(r"ApiErrorHandler:OnServerError", re.IGNORECASE),
        ),
        representative_patterns=(
            re.compile(r"Service Temporarily Unavailable", re.IGNORECASE),
            re.compile(r"Fail Request:", re.IGNORECASE),
            re.compile(r"\[OnServerError\]", re.IGNORECASE),
        ),
    ),
    IssueRule(
    ...
    IssueRule(
        ...
        patterns=(
            ...
            re.compile(r"HANDLE_COMMAND_TIME_OUT", re.IGNORECASE),
    ...
    IssueRule(
        ...
        patterns=(
            ...
            re.compile(r"Failed to change display to ExclusiveFullscreen", re.IGNORECASE),
        ),
        representative_patterns=(re.compile(r"Failed to change display to ExclusiveFullscreen", re.IGNORECASE),),
    ),
    IssueRule(
        key="input_device_failure",
        title="입력 장치 데이터 수집 실패",
        impact="키보드나 마우스 같은 입력 장치 데이터를 읽는 과정에서 실패가 반복된 것으로 보입니다.",
        cause="Raw Input 장치 초기화나 입력 데이터 수집 단계에서 문제가 발생했을 가능성이 높습니다.",
        patterns=(re.compile(r"^<Raw Input> Failed to get raw input data:", re.IGNORECASE),),
        representative_patterns=(re.compile(r"^<Raw Input> Failed to get raw input data:", re.IGNORECASE),),
    ),
    IssueRule(
    ...
    IssueRule(
        ...
        patterns=(
            ...
            re.compile(r"mySightAgent is null", re.IGNORECASE),
            re.compile(r"Not Exist Main sight", re.IGNORECASE),
    ...
    IssueRule(
        ...
        patterns=(
            ...
            re.compile(r"Failed to find item by itemCode", re.IGNORECASE),
            re.compile(r"WeaponMount not Find", re.IGNORECASE),
            re.compile(r"SpringBone Setting Error", re.IGNORECASE),
            re.compile(r"StartPositionService:AssignmentAlgorithm", re.IGNORECASE),
        ),
        representative_patterns=(
            re.compile(r"StateType parsing error", re.IGNORECASE),
            re.compile(r"Invalid Data \[", re.IGNORECASE),
